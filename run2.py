...
if __name__ == '__main__':
    ...
    # TBPTT and MoE settings
    parser.add_argument('--use_tbptt', action='store_true', help='use truncated backpropagation through time for training', default=False)
    parser.add_argument('--rollout_steps', type=int, default=2, help='number of rollout steps for TBPTT (2-3 recommended)')
    parser.add_argument('--use_moe_prefix', action='store_true', help='use mixture of experts prefix (Anchor + Predictor)', default=False)
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.use_prefix:
                setting = '{}_{}_{}_{}_sl{}_ll{}_tl{}_lr{}_bt{}_wd{}_hd{}_hl{}_cos{}_mix{}_pl{}_pmh{}_pml{}_mpl{}_tbptt{}_moe{}_{}_{}'.format(
                    args.task_name,
                    args.model_id,
                    args.model,
                    args.data,
